<template>
  <v-card title="Parroquias" subtitle="Gestión de parroquias">
    <LnxDataTable :loadDataTable="_loadDataTable" :headers="headers">
      ...
      <template v-slot:item.actions="{ item, loadDataTable }">
        <v-btn
          v-permission="['editar_parroquia', 'eliminar_parroquia']"
          icon
          size="small"
          variant="text"
        >
          ...
          <v-menu activator="parent">
            <v-list nav>
              ...
              <v-list-item
                v-permission="['eliminar_parroquia']"
                title="Eliminar"
                class="text-red"
                density="compact"
                value="delete"
