<template>
  <v-card
    ...
    subtitle="Gestión de participantes en el sacramento"
  >
    <template #append>
      <v-btn
        icon
    ...
    <LnxDataTable :loadDataTable="loadDataTable" :headers="headersParticipants">
      <template
        v-slot:header="{
          request,
          loading,
...
import { headersParticipants } from "@/app/modules/sacrament/constants/sacrament.constants.ts";

import BaptismParticipantForm from "@/app/modules/baptism/components/BaptismParticipantForm.vue";
import DefineParameters from "@/app/modules/sacrament/components/DefineParameters.vue";

import FormAct from "@/app/modules/baptism/components/FormAct.vue";
