<template>
  <v-card
    ...
    subtitle="Registros de personas para confirmación"
    :disabled="loading"
  >
    <v-card-item class="border-t border-b">
      <v-row class="d-flex justify-space-between">
        ...
        <v-col cols="12" md="4" class="d-md-flex d-block justify-end text-end">
          ...
          >
            nuevo
            <ConfirmationForm @onSuccess="reLoadDataTable" />
          </v-btn>
          <v-btn
            class="h-md-auto"
            density="comfortable"
...
import { ConfirmationDataTable, ConfirmationForm } from "../components";
